...
public class BuscadorCaminoOptimoTest {
    ...
    public void test() throws Exception {
        ...
        final Posicion[] tp = new BuscadorCaminoOptimo().buscar(elementos, new Posicion(0, 0), new Posicion(1, 1));
    ...
    public void test2() throws Exception {
        ...
        elementos[2][2] = new Elemento('A', 1);
        elementos[2][3] = new Elemento('A', 1);
        final Posicion[] tp = new BuscadorCaminoOptimo().buscar(elementos, new Posicion(1, 1), new Posicion(2, 3));
